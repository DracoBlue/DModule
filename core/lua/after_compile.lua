...
require ("utils")
project.cfg=readCfgFile(".."..directory_delimiter..".."..directory_delimiter.."projects"..directory_delimiter..project.name..directory_delimiter.."settings.cfg")

if (project.cfg["documentation"]=="full") then
	local xml_file = file_get_contents(".."..directory_delimiter..".."..directory_delimiter.."projects"..directory_delimiter..project.name..directory_delimiter.."compile.info.log")
	...
	if (xml_file~=nil) then
		...
		file_put_contents(".."..directory_delimiter..".."..directory_delimiter.."projects"..directory_delimiter..project.name..directory_delimiter.."docs.wiki.txt",table.concat(wiki_txt,"\n"))
	end
end
