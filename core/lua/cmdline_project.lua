...
function cmdline_project(params)
	...
	if (command ~= "help" and command ~= "create") then
		...
		if (lfs.attributes(".."..directory_delimiter..".."..directory_delimiter.."projects"..directory_delimiter..p[1]) == nil) then
...
function cmdline_project_name(params)
	...
	print("   "..params[2])
	setCfgFileLine(".."..directory_delimiter..".."..directory_delimiter.."projects"..directory_delimiter..project.name..directory_delimiter.."settings.cfg","name",params[2])
end

function cmdline_project_create(params)
	project={}
	project.name = params[1]
	if (lfs.attributes(".."..directory_delimiter..".."..directory_delimiter.."projects"..directory_delimiter..project.name) ~= nil) then
	...
	os.execute("mkdir "..".."..directory_delimiter..".."..directory_delimiter.."projects"..directory_delimiter..project.name);
	if (lfs.attributes(".."..directory_delimiter..".."..directory_delimiter.."projects"..directory_delimiter..project.name) == nil) then
	...
	file_put_contents(".."..directory_delimiter..".."..directory_delimiter.."projects"..directory_delimiter..project.name..directory_delimiter.."settings.cfg","name="..project.name)
	setCfgFileLine(".."..directory_delimiter..".."..directory_delimiter.."projects"..directory_delimiter..project.name..directory_delimiter.."settings.cfg","server.rcon_password",params[2])
end
...
function cmdline_project_var(params)
	...
	if (params[2]==nil) then
		...
		cfg = readCfgFile(".."..directory_delimiter..".."..directory_delimiter.."projects"..directory_delimiter..project.name..directory_delimiter.."settings.cfg")
		...
		if (params[3]==nil) then
			...
			unsetCfgFileLine(".."..directory_delimiter..".."..directory_delimiter.."projects"..directory_delimiter..project.name..directory_delimiter.."settings.cfg","server."..params[2])
			print("   Unsetted '"..params[2].."'")
		else
			-- if we have a 3rd parameter, it means we want to set the variable
			setCfgFileLine(".."..directory_delimiter..".."..directory_delimiter.."projects"..directory_delimiter..project.name..directory_delimiter.."settings.cfg","server."..params[2],params[3])
...
function cmdline_project_modules(params)
	...
	if (task == "list") then
		...
		for _,module in pairs(project.settings_modules) do
			...
			for _,folder in pairs(project.moduledirectories) do
				if (nil ~= file_get_contents(".."..directory_delimiter..".."..directory_delimiter..folder..directory_delimiter..module.name..directory_delimiter..module.name..".dmodule.inc")) then
	...
	if (task == "clear") then
		...
		setCfgFileLine(".."..directory_delimiter..".."..directory_delimiter.."projects"..directory_delimiter..project.name..directory_delimiter.."settings.cfg","modules","")
		print("   -- none selected --")
		return nil
	end
	...
	if (table.concat(new_module_line_items," ") ~= project.cfg.modules) then
		-- set only if changed
		setCfgFileLine(".."..directory_delimiter..".."..directory_delimiter.."projects"..directory_delimiter..project.name..directory_delimiter.."settings.cfg","modules",table.concat(new_module_line_items," "))
	end
end
